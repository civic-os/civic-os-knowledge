...
type CreateInput struct {
	...
	Type        string   `json:"type" jsonschema:"Concept type (e.g. Client Profile, Decision Record, Runbook)"`
...
func CreateTool() *mcp.Tool {
	return &mcp.Tool{
		Name:        "kb_create",
		Description: "Create a new knowledge concept. Specify the file path, type, title, and body content.",
	}
}
